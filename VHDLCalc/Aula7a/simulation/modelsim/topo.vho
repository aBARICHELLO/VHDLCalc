...
SIGNAL \L0|EA.E1~DUPLICATE_q\ : std_logic;
SIGNAL \L0|contagem~4_combout\ : std_logic;
SIGNAL \L0|EA.E2~DUPLICATE_q\ : std_logic;
...
SIGNAL \L0|ALT_INV_EA.E2~DUPLICATE_q\ : std_logic;
SIGNAL \L0|ALT_INV_EA.E1~DUPLICATE_q\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\L0|ALT_INV_EA.E2~DUPLICATE_q\ <= NOT \L0|EA.E2~DUPLICATE_q\;
\L0|ALT_INV_EA.E1~DUPLICATE_q\ <= NOT \L0|EA.E1~DUPLICATE_q\;
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \L0|EA.E1~DUPLICATE_q\);

-- Location: LABCELL_X88_Y4_N48
\L0|contagem~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \L0|contagem~4_combout\ = (\L0|EA.E1~DUPLICATE_q\) # (\L0|EA.E3~q\)
...
-- pragma translate_on
PORT MAP (
	dataa => \L0|ALT_INV_EA.E3~q\,
	datab => \L0|ALT_INV_EA.E1~DUPLICATE_q\,
	combout => \L0|contagem~4_combout\);

-- Location: FF_X88_Y4_N55
\L0|EA.E2~DUPLICATE\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \L0|contagem\(1) = ( \L0|EA.E2~DUPLICATE_q\ ) # ( !\L0|EA.E2~DUPLICATE_q\ & ( \L0|EA.E1~DUPLICATE_q\ ) )
...
PORT MAP (
	datab => \L0|ALT_INV_EA.E1~DUPLICATE_q\,
	datae => \L0|ALT_INV_EA.E2~DUPLICATE_q\,
...
-- Equation(s):
-- \L1|F~0_combout\ = ( \L0|EA.E2~DUPLICATE_q\ & ( \L0|EA.E4~q\ ) ) # ( !\L0|EA.E2~DUPLICATE_q\ & ( \L0|EA.E4~q\ & ( (!\L0|EA.E3~q\) # (\L0|EA.E1~DUPLICATE_q\) ) ) ) # ( \L0|EA.E2~DUPLICATE_q\ & ( !\L0|EA.E4~q\ ) ) # ( !\L0|EA.E2~DUPLICATE_q\ & ( 
-- !\L0|EA.E4~q\ & ( \L0|EA.E1~DUPLICATE_q\ ) ) )
...
-- Equation(s):
-- \L1|F[1]~1_combout\ = ( \L0|EA.E2~DUPLICATE_q\ & ( \L0|EA.E4~q\ & ( (\L0|EA.E1~DUPLICATE_q\) # (\L0|EA.E3~q\) ) ) ) # ( !\L0|EA.E2~DUPLICATE_q\ & ( \L0|EA.E4~q\ & ( (!\L0|EA.E3~q\) # (\L0|EA.E1~DUPLICATE_q\) ) ) ) # ( \L0|EA.E2~DUPLICATE_q\ & ( 
-- !\L0|EA.E4~q\ & ( \L0|EA.E3~q\ ) ) ) # ( !\L0|EA.E2~DUPLICATE_q\ & ( !\L0|EA.E4~q\ & ( (\L0|EA.E3~q\ & \L0|EA.E1~DUPLICATE_q\) ) ) )
...
-- Equation(s):
-- \L1|F[2]~2_combout\ = ( \L0|EA.E3~q\ & ( \L0|EA.E4~q\ ) ) # ( !\L0|EA.E3~q\ & ( \L0|EA.E4~q\ ) ) # ( \L0|EA.E3~q\ & ( !\L0|EA.E4~q\ ) ) # ( !\L0|EA.E3~q\ & ( !\L0|EA.E4~q\ & ( !\L0|EA.E1~DUPLICATE_q\ ) ) )
...
-- pragma translate_on
PORT MAP (
	datac => \L0|ALT_INV_EA.E1~DUPLICATE_q\,
	datae => \L0|ALT_INV_EA.E3~q\,
	dataf => \L0|ALT_INV_EA.E4~q\,
...
-- Equation(s):
-- \L1|F[4]~3_combout\ = ( !\L0|EA.E2~DUPLICATE_q\ & ( \L0|EA.E4~q\ & ( !\L0|EA.E1~DUPLICATE_q\ ) ) ) # ( \L0|EA.E2~DUPLICATE_q\ & ( !\L0|EA.E4~q\ & ( (!\L0|EA.E3~q\ & !\L0|EA.E1~DUPLICATE_q\) ) ) ) # ( !\L0|EA.E2~DUPLICATE_q\ & ( !\L0|EA.E4~q\ & ( 
-- !\L0|EA.E1~DUPLICATE_q\ ) ) )
...
-- Equation(s):
-- \L1|F[6]~4_combout\ = ( \L0|EA.E1~DUPLICATE_q\ ) # ( !\L0|EA.E1~DUPLICATE_q\ & ( ((\L0|EA.E2~DUPLICATE_q\) # (\L0|EA.E4~q\)) # (\L0|EA.E3~q\) ) )
...
PORT MAP (
	dataa => \L0|ALT_INV_EA.E3~q\,
	datab => \L0|ALT_INV_EA.E4~q\,
	datad => \L0|ALT_INV_EA.E2~DUPLICATE_q\,
	datae => \L0|ALT_INV_EA.E1~DUPLICATE_q\,
